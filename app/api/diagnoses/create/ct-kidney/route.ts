...
export async function POST(request: NextRequest) {
  try {
    ...
    const aiResult: ChestXrayResult = await processKidneyImage(imageBlob);
    ...
    const aiAnalysisResults = {
      model_type: "ct-kidney",
      model_name: aiResult.modelType || "ct-kidney",
